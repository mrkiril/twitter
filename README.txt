...
Next step do only from virtualenv or pyvenv
	0) in file setting/setting.ini you can set ip and port which will be listening server
	1) And set the path to the database. Without this path serv will not start
